...
function university_files() {
	wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyCNiZMU4pjJA0P3dpr0eNUT4XcBEVsVPcQ', null, '1.0', true);
...
function universityMapKey($api) {
	$api['key'] = 'AIzaSyCNiZMU4pjJA0P3dpr0eNUT4XcBEVsVPcQ';
...
add_filter('login_headerurl', 'setHeaderUrl');
...
add_action('login_enqueue_scripts', 'setLoginStyle');
...
function makeNotePrivate($data, $postarr) {
	if ($data['post_type'] === 'note') {
        if (count_user_posts(get_current_user_id(), 'note') > 4 and !$postarr['ID'])
            die("U have reached your note limit.");
